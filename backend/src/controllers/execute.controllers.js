...
export const executeCode = async (req, res) => {
  try {
    ...
    //  checking if the test cases, the inputanfd output  is coming in array format
    console.log("stdin:", stdin);
console.log("expected_outputs:", expected_outputs);
    if (
      !Array.isArray(stdin) ||
      stdin.length === 0 ||
    ...
    // 2. Preparing  each test cases for judge0 batch submission
    ...
    // 4. Polling  judge0 for results of all submitted test cases
